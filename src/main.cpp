...
const string strMessageInvestPlus = "InvestPlus Signed Message:\n";
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // InvestPlus: check proof-of-stake block signature
...
// InvestPlus: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "InvestPlus", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "InvestPlus for world economy October 2018";
        CTransaction txNew;
        txNew.nTime = 1546967906;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nNonce   = !fTestNet ? 1184719 : 116016;
	...
	fflush(NULL);
        ...
        assert(block.hashMerkleRoot == uint256("0x522cead0754331df15160fd4bcead0b22ffdef0b95c8fbd545a7770a07e3be04"));
